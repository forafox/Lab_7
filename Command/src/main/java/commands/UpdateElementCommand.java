...
////                        values[i - 1] = subStr[1];
////                    }
////                    LabWork labWork = LabWorkFieldReplacing.update(cdh.getLabWorkById(id), fields, values, printStream);
////                    cdh.replaceRow(labWork);
////                    collectionManager.removeKey(labWork.getId());
////                    collectionManager.insert(labWork.getId(), labWork, printStream);
////                } else {
